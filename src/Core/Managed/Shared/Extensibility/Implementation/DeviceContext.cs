namespace Microsoft.ApplicationInsights.Extensibility.Implementation
{
    ...
    public sealed class DeviceContext
    {
        ...
        /// </summary>
        [Obsolete("Use custom properties to associate telemetry item with the network type.")]
        ...
        /// </summary>
        [Obsolete("Use custom properties to associate telemetry item with the device screen resolution.")]
        ...
        /// </summary>
        [Obsolete("Use custom properties to associate telemetry item with the device language.")]
